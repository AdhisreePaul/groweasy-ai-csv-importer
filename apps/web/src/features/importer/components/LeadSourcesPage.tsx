...
const actionCardClassName = [
  "h-[101px] rounded-[12px] border border-dashed border-[#CFE4E1] bg-white",
  "px-[26px] text-left transition hover:border-[#216B62] hover:bg-[#FBFEFD]",
  ...
  return (
    <div className="min-h-screen bg-white" id="lead-sources">
      ...
      <div className="mx-auto w-full max-w-[1018px] px-4 pb-[28px] pt-[28px] sm:px-0 lg:mx-0 lg:ml-[74px]">
        <section aria-label="Lead source actions" className="grid gap-[17px] md:grid-cols-2">
          <button className={actionCardClassName} onClick={onOpenImport} type="button">
          ...
          <button className={actionCardClassName} type="button">
            <div className="flex items-center gap-[19px]">
              <span className="flex h-[47px] w-[47px] shrink-0 items-center justify-center rounded-full bg-[#E7F5F3] text-[#216B62]">
        ...
        {importResult ? (
          <section aria-labelledby="manage-leads-heading" className="mt-[28px] space-y-5">
            <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
              <div>
                <h2 className="text-[21px] font-extrabold text-[#0F172A]" id="manage-leads-heading">
                  Manage Your Leads
                </h2>
                <p className="mt-1 text-[13px] font-medium text-[#667085]">
                  Review imported CRM records and skipped rows from the latest CSV run.
                </p>
              </div>
            ...
            <Card className="p-5 shadow-none">
              <div className="mb-4">
                <h3 className="text-[16px] font-extrabold text-[#0F172A]">Imported Records</h3>
            ...
            <Card className="p-5 shadow-none">
              <div className="mb-4">
                <h3 className="text-[16px] font-extrabold text-[#0F172A]">Skipped Records</h3>
                <p className="mt-1 text-[13px] text-[#667085]">
